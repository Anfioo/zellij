...
/// `BreakPanesToTabWithIdResponse` 中的嵌套消息和枚举类型。
...
pub struct ListTokensResponse {
    /// tokens/creation_times/read_only_flags 应同步
    #[prost(string, repeated, tag="1")]
...
/// `GetPanePidResponse` 中的嵌套消息和枚举类型。
...
/// `GetPaneRunningCommandResponse` 中的嵌套消息和枚举类型。
...
/// `GetPaneCwdResponse` 中的嵌套消息和枚举类型。
...
/// `SaveLayoutResponse` 中的嵌套消息和枚举类型。
...
/// `DeleteLayoutResponse` 中的嵌套消息和枚举类型。
...
/// `EditLayoutResponse` 中的嵌套消息和枚举类型。
...
/// `DumpLayoutResponse` 中的嵌套消息和枚举类型。
...
/// `DumpSessionLayoutResponse` 中的嵌套消息和枚举类型。
...
/// `ParseLayoutResponse` 中的嵌套消息和枚举类型。
...
/// `RenameLayoutResponse` 中的嵌套消息和枚举类型。
...
/// `GetFocusedPaneInfoResponse` 中的嵌套消息和枚举类型。
...
/// `SaveSessionResponse` 中的嵌套消息和枚举类型。
...
pub struct CurrentSessionLastSavedTimeResponse {
    /// 如果从未保存则为 None，否则为自上次保存以来经过的毫秒数
    #[prost(uint64, optional, tag="1")]
...
/// `NewTabUnfocusedResponse` 中的嵌套消息和枚举类型。
...
/// `FocusOrCreateTabResponse` 中的嵌套消息和枚举类型。
...
/// `BreakPanesToNewTabResponse` 中的嵌套消息和枚举类型。
...
/// `BreakPanesToTabWithIndexResponse` 中的嵌套消息和枚举类型。
...
/// `ShowFloatingPanesResponse` 中的嵌套消息和枚举类型。
...
/// `HideFloatingPanesResponse` 中的嵌套消息和枚举类型。
...
/// `GetSessionListResponse` 中的嵌套消息和枚举类型。
